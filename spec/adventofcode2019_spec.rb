RSpec.describe Adventofcode2019 do
  describe ".calculate_total_fuel_required_v1" do
    it "calculates the sum of the fuel requirements for all of the given masses" do
      result = Adventofcode2019.calculate_total_fuel_required_v1(masses_file_path: "#{files_dir}/sample_masses.txt")
  ...
  describe ".calculate_total_fuel_required" do
    it "calculates the sum of the fuel requirements for all of the given masses" do
      result = Adventofcode2019.calculate_total_fuel_required(masses_file_path: "#{files_dir}/sample_masses.txt")
